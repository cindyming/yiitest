...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['bonus_total', 'merit_total', 'duichong_invest', 'duichong_total', 'duichong_remain'], 'double'],
            [['bonus_remain', 'baodan_remain', 'baodan_total'], 'number', 'min' => 0, 'tooSmall' => '会员' . $this->id . '分工余额不足', 'on' => 'cancel'],
